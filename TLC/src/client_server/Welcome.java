...
public class Welcome extends JPanel{
	...
	public Welcome() {
		...
		a.setIconImage(Toolkit.getDefaultToolkit().getImage("C:/Users/Marco/workspace/TLC/src/kali.png"));
	...
	protected void paintComponent(Graphics g) {
		...
		try {
			bi = ImageIO.read(new File("C:/Users/Marco/workspace/TLC/src/kali.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
